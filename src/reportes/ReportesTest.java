...
public class ReportesTest {
    ...
    public void testOrdenarPorCaracteristicas() {
        Personaje batman = new Personaje(Tipos.HEROE, "Bruce Wayne", "Batman", new Caracteristicas(10, 20, 30, 40));
        Personaje joker = new Personaje(Tipos.VILLANO, "Joker", "Joker", new Caracteristicas(15, 25, 30, 45));
